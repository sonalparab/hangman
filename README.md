...
* There is a limit of about 60,000 words a subserver has before running out (we do not handle this). So essentially if you play too much the game probably breaks.
